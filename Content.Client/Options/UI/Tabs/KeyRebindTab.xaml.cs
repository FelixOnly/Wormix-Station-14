    ...
    public sealed partial class KeyRebindTab : Control
    {
        ...
        private void PopulateOptions()
        {
            ...
            bool ShouldDisplayButton(BoundKeyFunction function)
            {
                ...
                if (_searchText.StartsWith(optionText, StringComparison.OrdinalIgnoreCase))
                {
                    return true;
                }

                if (_searchText.Contains(optionText, StringComparison.OrdinalIgnoreCase))
                {
                    return true;
                }

                if (FuzzySearching.LevensteinAlgorithm(_searchText, optionText) < 10)
                {
                    return true;
                }
