...
public sealed partial class FancyVendingMachineMenu : FancyWindow
{
    ...
    /// </summary>
    public void Populate(EntityUid entityUid, List<VendingMachineInventoryEntry> inventory)
    {
        _cachedItems.Clear();
    ...
    private void PopulateList()
    {
        ...
        foreach (var item in _cachedItems.Where(d => DataFilterCondition(SearchBar.Text, d)))
        {
            ...
            var listItem = new FancyVendingMachineItem(item.Entry.ID, item.Name, (int)item.Entry.Amount);
